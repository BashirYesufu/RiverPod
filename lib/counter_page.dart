    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          children: [
            ...
            Text(user.password, style: Theme.of(context).textTheme.subtitle1),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          ref.read(userProvider.notifier).state.email = "newmail@mail.com";
          ref.read(userProvider.notifier).state.password = "Password1!";
        },
